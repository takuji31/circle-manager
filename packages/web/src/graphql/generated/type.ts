...
export type ListedCircleFragment = {
  __typename?: 'Circle';
  id: string;
  key: CircleKey;
  name: string;
...
export type ListedMemberFragment = {
  __typename?: 'Member';
  id: string;
  name: string;
...
export type FullMemberFragment = {
  __typename?: 'Member';
  id: string;
  pathname: string;
  name: string;
  ...
  circleRole: CircleRole;
  circle?: { __typename?: 'Circle'; id: string; name: string } | null;
};

export type MonthAndSurveyFragment = {
  __typename?: 'Month';
  year: number;
  month: number;
  survey?: {
...
export type MonthAndSurveyWithMembersFragment = {
  __typename?: 'Month';
  year: number;
  month: number;
  survey?: {
    ...
    month: number;
    expiredAt: any;
    monthSurveyAnswers: Array<{
      __typename?: 'MonthSurveyAnswer';
      id: string;
      year: number;
      month: number;
      circleKey: CircleKey;
      value?: MonthSurveyAnswerValue | null;
    }>;
  } | null;
};

export type MemberMonthCircleFragment = {
  __typename?: 'MonthCircle';
  id: string;
  year: number;
  month: number;
...
export type FullMonthCircleFragment = {
  __typename?: 'MonthCircle';
  state: MonthCircleState;
  kicked: boolean;
  invited: boolean;
...
export type ListedMonthSurveyAnswerFragment = {
  __typename?: 'MonthSurveyAnswer';
  id: string;
  year: number;
  month: number;
...
export type ListedSignUpFragment = {
  __typename?: 'SignUp';
  id: string;
  invited: boolean;
  joined: boolean;
...
export type CreateNextMonthCirclesMutationVariables = Exact<{
  [key: string]: never;
}>;
...
export type CreateNextMonthSurveyMutationVariables = Exact<{
  [key: string]: never;
}>;

export type CreateNextMonthSurveyMutation = {
  __typename?: 'Mutation';
...
export type UpdateMemberMonthCircleMutation = {
  __typename?: 'Mutation';
...
export type UpdateMonthCircleMutation = {
  __typename?: 'Mutation';
  updateMonthCircle?: {
    __typename?: 'UpdateMemberMonthCirclePayload';
    monthCircle: {
...
export type AdminMemberMonthCircleQuery = {
  __typename?: 'Query';
  member?: {
    __typename?: 'Member';
    id: string;
...
export type AdminTopQuery = {
  ...
  siteMetadata: { __typename?: 'SiteMetadata'; activeMembers: number };
  signUps: Array<{
    __typename?: 'SignUp';
    id: string;
    invited: boolean;
...
export type MemberMonthCirclesQuery = {
  __typename?: 'Query';
  member?: {
    __typename?: 'Member';
    thisMonthCircle?: {
...
export type MemberByPathnameQuery = {
  __typename?: 'Query';
  member?: {
    __typename?: 'Member';
    id: string;
...
export type NextMonthCirclesQuery = {
  __typename?: 'Query';
  nextMonth: {
    __typename?: 'Month';
    monthCircles: Array<{
...
export const FullMemberFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'FullMember' },
      typeCondition: {
        kind: 'NamedType',
      ...
      selectionSet: {
        ...
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'setupCompleted' } },
          {
            kind: 'Field',
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'circleRole' } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<FullMemberFragment, unknown>;
export const MonthAndSurveyFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'MonthAndSurvey' },
      typeCondition: {
        kind: 'NamedType',
...
} as unknown as DocumentNode<MonthAndSurveyFragment, unknown>;
export const MonthAndSurveyWithMembersFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'MonthAndSurveyWithMembers' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'Month' },
      },
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'month' } },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'monthSurveyAnswers' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      { kind: 'Field', name: { kind: 'Name', value: 'id' } },
...
} as unknown as DocumentNode<MonthAndSurveyWithMembersFragment, unknown>;
export const ListedCircleFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'ListedCircle' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'Circle' },
      },
...
} as unknown as DocumentNode<ListedCircleFragment, unknown>;
export const MemberMonthCircleFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
...
} as unknown as DocumentNode<MemberMonthCircleFragment, unknown>;
export const ListedMemberFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'ListedMember' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'Member' },
      },
...
} as unknown as DocumentNode<ListedMemberFragment, unknown>;
export const FullMonthCircleFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'FullMonthCircle' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'MonthCircle' },
      },
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'leavedAt' } },
              ],
            },
          },
          { kind: 'Field', name: { kind: 'Name', value: 'state' } },
          { kind: 'Field', name: { kind: 'Name', value: 'kicked' } },
          { kind: 'Field', name: { kind: 'Name', value: 'invited' } },
          { kind: 'Field', name: { kind: 'Name', value: 'joined' } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<FullMonthCircleFragment, unknown>;
export const ListedMonthSurveyAnswerFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
      name: { kind: 'Name', value: 'ListedMonthSurveyAnswer' },
      typeCondition: {
        kind: 'NamedType',
        name: { kind: 'Name', value: 'MonthSurveyAnswer' },
      },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          ...
          { kind: 'Field', name: { kind: 'Name', value: 'year' } },
          { kind: 'Field', name: { kind: 'Name', value: 'month' } },
          { kind: 'Field', name: { kind: 'Name', value: 'circleKey' } },
          { kind: 'Field', name: { kind: 'Name', value: 'value' } },
        ],
      },
    },
  ],
} as unknown as DocumentNode<ListedMonthSurveyAnswerFragment, unknown>;
export const ListedSignUpFragmentDoc = {
  kind: 'Document',
  definitions: [
    {
      kind: 'FragmentDefinition',
...
} as unknown as DocumentNode<ListedSignUpFragment, unknown>;
export const CreateNextMonthCirclesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'CreateNextMonthCircles' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            ...
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'withoutNewMembers' },
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'monthCircles' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
    ...
    ...FullMonthCircleFragmentDoc.definitions,
    ...MemberMonthCircleFragmentDoc.definitions,
    ...ListedCircleFragmentDoc.definitions,
    ...ListedMemberFragmentDoc.definitions,
  ],
} as unknown as DocumentNode<
  CreateNextMonthCirclesMutation,
  CreateNextMonthCirclesMutationVariables
>;
export const CreateNextMonthSurveyDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'nextMonth' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
    ...
    ...MonthAndSurveyFragmentDoc.definitions,
  ],
} as unknown as DocumentNode<
  CreateNextMonthSurveyMutation,
  CreateNextMonthSurveyMutationVariables
>;
export const UpdateMemberDocument = {
  ...
  definitions: [
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'UpdateMemberMutationInput' },
            },
          },
        },
      ],
    ...
    ...FullMemberFragmentDoc.definitions,
  ],
} as unknown as DocumentNode<
  UpdateMemberMutation,
  UpdateMemberMutationVariables
>;
export const UpdateMemberMonthCircleDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateMemberMonthCircle' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
          ...
          type: {
            ...
            type: {
              ...
              name: {
                kind: 'Name',
                value: 'UpdateMemberMonthCircleMutationInput',
              },
            },
          },
        },
  ...
  UpdateMemberMonthCircleMutation,
  UpdateMemberMonthCircleMutationVariables
>;
export const UpdateMembersDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'thisMonthCircle' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'nextMonthCircle' },
                  selectionSet: {
                    kind: 'SelectionSet',
                    selections: [
                      {
...
>;
export const UpdateMonthCircleDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      ...
      variableDefinitions: [
        {
          ...
          type: {
            ...
            type: {
              kind: 'NamedType',
              name: { kind: 'Name', value: 'UpdateMonthCircleMutationInput' },
            },
          },
        },
      ],
  ...
  UpdateMonthCircleMutation,
  UpdateMonthCircleMutationVariables
>;
export const UpdateSetupDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateSetup' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'trainerId' },
          },
          type: {
            kind: 'NonNullType',
            type: {
      ...
      selectionSet: {
        ...
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'updateSignUp' },
            arguments: [
              {
                kind: 'Argument',
                name: { kind: 'Name', value: 'input' },
            ...
            arguments: [
              {
                ...
                value: {
                  ...
                  fields: [
                    ...
                    {
                      kind: 'ObjectField',
                      name: { kind: 'Name', value: 'setupCompleted' },
                      value: { kind: 'BooleanValue', value: true },
                    },
                  ],
                },
    ...
    ...ListedSignUpFragmentDoc.definitions,
    ...ListedMemberFragmentDoc.definitions,
    ...ListedCircleFragmentDoc.definitions,
    ...FullMemberFragmentDoc.definitions,
  ],
} as unknown as DocumentNode<UpdateSetupMutation, UpdateSetupMutationVariables>;
export const UpdateSignUpDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
>;
export const AdminCirclesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'AdminCircles' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
...
} as unknown as DocumentNode<AdminCirclesQuery, AdminCirclesQueryVariables>;
export const AdminMemberMonthCircleDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'AdminMemberMonthCircle' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  AdminMemberMonthCircleQuery,
  AdminMemberMonthCircleQueryVariables
>;
export const AdminMembersDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'AdminMembers' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
    ...
    ...MemberMonthCircleFragmentDoc.definitions,
    ...ListedCircleFragmentDoc.definitions,
    ...ListedMonthSurveyAnswerFragmentDoc.definitions,
  ],
} as unknown as DocumentNode<AdminMembersQuery, AdminMembersQueryVariables>;
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'MonthSurvey' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: { kind: 'Variable', name: { kind: 'Name', value: 'year' } },
...
} as unknown as DocumentNode<MonthSurveyQuery, MonthSurveyQueryVariables>;
export const AdminTopDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'AdminTop' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
            kind: 'Field',
            name: { kind: 'Name', value: 'thisMonth' },
            selectionSet: {
              kind: 'SelectionSet',
              selections: [
                {
          ...
          },
          {
            ...
            selectionSet: {
              ...
              selections: [
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'activeMembers' },
                },
              ],
            },
          },
    ...
    ...MonthAndSurveyFragmentDoc.definitions,
    ...MonthAndSurveyWithMembersFragmentDoc.definitions,
    ...ListedSignUpFragmentDoc.definitions,
    ...ListedMemberFragmentDoc.definitions,
    ...ListedCircleFragmentDoc.definitions,
  ],
} as unknown as DocumentNode<AdminTopQuery, AdminTopQueryVariables>;
export const MemberMonthCirclesDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'MemberMonthCircles' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  MemberMonthCirclesQuery,
  MemberMonthCirclesQueryVariables
>;
export const MemberByPathnameDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'MemberByPathname' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  MemberByPathnameQuery,
  MemberByPathnameQueryVariables
>;
export const NextMonthCirclesDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'query',
      name: { kind: 'Name', value: 'NextMonthCircles' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
                      ...
                      },
                      {
                        ...
                        selectionSet: {
                          ...
                          selections: [
                            {
                              kind: 'Field',
                              name: { kind: 'Name', value: 'messageChannelId' },
                            },
                          ],
                        },
                      },
  ...
  NextMonthCirclesQuery,
  NextMonthCirclesQueryVariables
>;
...
} as unknown as DocumentNode<SetupQuery, SetupQueryVariables>;
